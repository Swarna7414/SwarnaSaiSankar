            ...
            <div className='flex xl:flex-row flex-col justify-between gap-4'>
                <div className='h-min font-normal w-full flex flex-col justify-between gap-6'>
                    <div className='xl:ml-2 text-lg'>
                        <div>
                            ...
                            <div className='h-min w-full md:pt-0.5 xl:pt-2'>
                                <div className={`flex flex-col gap-5 h-min border-2 border-gray-500 px-5 py-5 rounded-2xl transition-all duration-300  ${darkMode ? 'hover:shadow-md hover:shadow-gray-500' : 'hover:border-orange-300 hover:shadow-md'}`}>
                    ...
                    <div className='h-min font-normal w-full'>
                        ...
                        <div className='h-min w-full md:pt-0.5 xl:pt-2'>
                                <div className={`flex flex-col gap-5 h-min border-2 border-gray-500 px-5 py-5 rounded-2xl transition-all duration-300 ${darkMode ? 'hover:shadow-md hover:shadow-gray-500' : 'hover:border-blue-300 hover:shadow-md hover:shadow-blue-400'}`}>
                ...
                <div className='w-full xl:mt-44 flex flex-col'>
                    ...
                    <div className={`flex flex-col gap-5 h-min border-2 border-gray-500 px-5 py-5 rounded-2xl transition-all duration-300 ${darkMode ? 'hover:shadow-md hover:shadow-gray-500' : 'hover:border-green-300 hover:shadow-md hover:shadow-green-400'}`}>
